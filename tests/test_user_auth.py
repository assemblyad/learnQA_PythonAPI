...
class TestUserAuth(BaseCase):
    ...
    @allure.description("This test successfully authorize user by e mail and password")
    ...
    """
    @allure.description("This test checks authorization status w/o sending auth or token")
